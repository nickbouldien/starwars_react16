...
const CustomAttributes = () => (
  <div id="customAttributes-div">
    ...
    <div tatooinenumberofsuns={2}><pre><code>tatooinenumberofsuns={2}</code></pre></div>

    <div starwarsweapons={weapons}><pre><code>starwarsweapons={weapons.toString()}</code></pre></div>

    <div data-macewindu="purpleLightsaber"><pre><code>data-macewindu="purpleLightsaber"</code></pre></div>
